...
#ifndef USER_LIB_LIB_H_
#define USER_LIB_LIB_H_
...
//int26死区
extern int int16_deadline(int Value, int minValue, int maxValue);
//限幅函数
extern float float_constrain(float Value, float minValue, float maxValue);
//限幅函数
extern int int16_constrain(int Value, int minValue, int maxValue);
//循环限幅函数
